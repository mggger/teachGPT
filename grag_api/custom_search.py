...
class LocalSearch(BaseSearch):
    ...
    async def asearch(
        ...
        context_builder_params = {**self.context_builder_params, **kwargs}
        if 'conversation_history_user_turns_only' in context_builder_params:
            del context_builder_params['conversation_history_user_turns_only']
